...
public class KangarooLogController implements Initializable {
    @FXML
    private AnchorPane rootKangarooLog;
    @FXML
    private Label kangarooLog;
    @FXML
    private Label kangarooDay;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            kangarooDay.setText("Kangaroo Details for Day - " + DayTableController.getDay());
            kangarooLog.setText(ConnectionUtil.getKangarooDetail(DayTableController.getRecordID(),
    ...
    public void logOut(ActionEvent actionEvent) {
        ...
        if (alert.getResult() == ButtonType.OK) {
            try {
                ...
                Main.switchSceneByFading(newScene,rootKangarooLog);
                return;
            } catch (IOException e) {
                e.printStackTrace();
            }
