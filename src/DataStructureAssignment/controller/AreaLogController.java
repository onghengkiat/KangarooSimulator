...
public class AreaLogController implements Initializable {
    @FXML
    private AnchorPane rootAreaLog;
    @FXML
    private Label areaLog;
    @FXML
    private Label areaDay;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            areaDay.setText("Area Details for Day - " + DayTableController.getDay());
            areaLog.setText(ConnectionUtil.getAreaDetail(DayTableController.getRecordID(),
    ...
    public void logOut(ActionEvent actionEvent) {
        ...
        if (alert.getResult() == ButtonType.OK) {
            try {
                ...
                Main.switchSceneByFading(newScene,rootAreaLog);
                return;
            } catch (IOException e) {
                e.printStackTrace();
            }
